...
/**
 * Created by Luis Grimaldo on 3/02/16.
 */
public class ListViewActivity extends Activity implements AdapterView.OnItemClickListener{
    ...
    private void initComponents(){
        lsvTema = (ListView)findViewById(R.id.lsv_tema);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position){
            ...
            case 1:
                ...
                bundle.putInt("posicion", position);
                bundle.putString("descripcion", descripciones[1]);
            ...
            case 2:
                ...
                bundle.putInt("posicion", position);
                bundle.putString("descripcion", descripciones[2]);
            ...
            case 3:
                ...
                bundle.putInt("posicion", position);
                bundle.putString("descripcion", descripciones[3]);
