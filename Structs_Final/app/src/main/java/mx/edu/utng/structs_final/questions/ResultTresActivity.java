...
public class ResultTresActivity extends Activity {
    ...
    public void playagain(View o) {
        Intent intent = new Intent(this, QuestionTresActivity.class);
    ...
    public void saveresult(View r) {
       ...
       // helper.insertResult(re);
        helper.actualizarQuiz(re,3);//id de la tabla resultado donde se guardara
        Toast resul = Toast.makeText(ResultTresActivity.this, "Resultado Guardado " + ca, Toast.LENGTH_SHORT);
        resul.show();
