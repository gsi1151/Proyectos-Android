...
public class ResultDosActivity extends Activity {
    ...
    public void playagain(View o) {
        Intent intent = new Intent(this, QuestionDosActivity.class);
    ...
    public void saveresult(View r) {
       ...
       // helper.insertResult(re);
        helper.actualizarQuiz(re,2);//id de la tabla resultado donde se guardara
        Toast resul = Toast.makeText(ResultDosActivity.this, "Resultado Guardado " + ca, Toast.LENGTH_SHORT);
        resul.show();
