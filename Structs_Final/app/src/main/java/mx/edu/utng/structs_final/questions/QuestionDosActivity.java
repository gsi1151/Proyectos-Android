...
public class QuestionDosActivity extends Activity {
    List<Question> quesList;
    int score = 0;
    int qid = 3;//inicia el la posicion de la pregunta
    Question currentQ;
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionDosActivity.this,
                   ResultDosActivity.class);
        ...
        if (qid <8) {// terminar en la pregunta
