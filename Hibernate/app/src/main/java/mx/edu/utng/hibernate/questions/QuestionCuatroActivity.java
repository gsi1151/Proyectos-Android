...
/**
 * Created by Luis Erika Cabrera on 25/02/2016.
 */
...
public class QuestionCuatroActivity extends Activity {
    List<Pregunta> quesList;
    int score = 0;
    int qid = 11;//traer la pregunta 1
    Pregunta currentQ;
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionCuatroActivity.this,
                   ResultCuatroActivity.class);
        ...
        if (qid <14) {// terminar en la pregunta
