...
public class QuestionSeisActivity extends Activity {
    List<Pregunta> quesList;
    int score = 0;
    int qid = 17;//traer la pregunta 1
    Pregunta currentQ;
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionSeisActivity.this,
                   ResultSeisActivity.class);
        ...
        if (qid <20) {// terminar en la pregunta
