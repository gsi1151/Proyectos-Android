...
public class    QuestionCincoActivity extends Activity {
    List<Pregunta> quesList;
    int score = 0;
    int qid = 14;//traer la pregunta 1
    Pregunta currentQ;
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionCincoActivity.this,
                   ResultCincoActivity.class);
        ...
        if (qid <17) {// terminar en la pregunta
