...
public class QuestionCodigoActivity extends Activity {
    List<Question> quesList;
    int score = 0;
    int qid = 20;//inicia el la posicion de la pregunta
    Question currentQ;
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionCodigoActivity.this,
                   ResultCodigoActivity.class);
        ...
        if (qid <25) {// terminar en la pregunta
