...
public class QuestionTresActivity extends Activity {
    ...
    public void getAnswer(String AnswerString) {
        if (currentQ.getANSWER().equals(AnswerString)) {
            ...
            Intent intent = new Intent(QuestionTresActivity.this,
                   ResultTresActivity.class);
        ...
        if (qid <11) {// terminar en la pregunta
