...
public class ResultActivity extends Activity {
    ...
    public void playagain(View o) {
        Intent intent = new Intent(this, QuestionUnoActivity.class);
    ...
    public void saveresult(View r) {
       ...
       // helper.insertResult(re);
        helper.actualizarQuiz(re,1);
        Toast resul = Toast.makeText(ResultActivity.this, "Resultado Guardado " + ca, Toast.LENGTH_SHORT);
        resul.show();
