...
public class ResultCuatroActivity extends Activity {
    ...
    public void playagain(View o) {
        Intent intent = new Intent(this, QuestionCuatroActivity.class);
    ...
    public void saveresult(View r) {
       ...
       // helper.insertResult(re);
        helper.actualizarQuiz(re,4);//id de la tabla resultado donde se guardara
        Toast resul = Toast.makeText(ResultCuatroActivity.this, "Resultado Guardado " + ca, Toast.LENGTH_SHORT);
        resul.show();
